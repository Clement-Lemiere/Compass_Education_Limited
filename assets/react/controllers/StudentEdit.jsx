                            ...
                            <div className="infoCtn">
                                {user.student && (
                                    <form className='formContent editProfile' onSubmit={handleSubmit}> 
                                        <label htmlFor="firstname" className='fullNameLabel formLabel'>Firstname :</label>
                                        <label htmlFor="lastname" className='fullNameLabel formLabel'>Lastname :</label>
                                        <input
                                            type="text"
                                            ...
                                            className='fullNameInput formControl'
                                        />
                                        <input
                                            type="text"
                                            ...
                                            className='fullNameInput formControl'
                                        />
                                        <label className='formLabel' htmlFor="birthdate">Birthdate :</label>
                                        <input
                                            type="date"
                                        ...
                                        />
                                        <label className='formLabel' htmlFor="nationality">Nationality :</label>
                                        <input
                                            type="text"
