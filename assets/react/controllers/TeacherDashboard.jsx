...
function TeacherDashboard() {
    ...
    const navigation = [
        ...
        { name: 'Lesson', href: '/teacherLesson', icon: bookIcon },        
    ...
    const renderProfileInfo = () => {
        if (user.teacher) {
            return (
                <>
                    <li><label>Firstname :</label><p>{user.teacher.firstName}</p></li>
                    <li><label>Lastname :</label><p> {user.teacher.lastName}</p></li>
                    <li><label>Nationality :</label><p> {user.teacher.nationality}</p></li>
                    <li><label>qualification :</label><p> {user.teacher.qualification}</p></li>
                    <li><label>availability : </label><p>{user.teacher.availability}</p></li>
